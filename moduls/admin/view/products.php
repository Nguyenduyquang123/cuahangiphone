            ...
            <div class="main-content">
                ...
                <table id="example" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <?php 
                        $i=0;
                        foreach($allpr as $items){
                            $i++;
                            $linkedit='index.php?pg=products_update&idpr='.$items['id'].'&id='.$items['id_prdetail'].'';
                            $linkdelete='index.php?pg=products_delete&idpr='.$items['id'].'&id='.$items['id_prdetail'].'';
                            echo ' <tr>
                            <td>'.$i.'</td>
